...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_tenantmembership_tenant_id'), 'tenantmembership', ['tenant_id'], unique=False)
    op.create_index(op.f('ix_tenantmembership_user_id'), 'tenantmembership', ['user_id'], unique=False)
    ...
    op.create_index(op.f('ix_documentfile_owner_id'), 'documentfile', ['owner_id'], unique=False)
    op.create_index(op.f('ix_documentfile_tenant_id'), 'documentfile', ['tenant_id'], unique=False)
